    ...
    pub fn new() -> Self {
        Self {
            colors: colors![
                ...
                // 青色
                "群青", "qunqin" => 46, 89, 167;
                "碧落", "biluo" => 174, 208, 238;
                "晴山", "qingshan" => 163, 187, 219;
                "品月", "pingyue" => 138, 171, 204;
                "窃蓝", "qielan" => 136, 171, 218;
                "挼蓝", "ruoluo" => 110, 155, 197;
                "监德", "jiande" => 111, 148, 205;
                "苍苍", "cangcang" => 89, 118, 186;
                "孔雀蓝", "kongquelan" => 73, 148, 196;
                "青冥", "qingming" => 50, 113, 174;
                "柔蓝", "roulan" => 16, 104, 152;
                "碧城", "bicheng" => 18, 80, 123;
                "蓝采和", "lancaihe" => 6,67, 111;
                "绀宇", "ganyu" => 0, 61, 116;
                "帝释青", "dishiqing" => 0, 52, 96;
                "佛头草", "fotoucao" => 25, 50, 95;
                "骐驎", "qilin" => 18, 38, 79;
                "花青", "huaqing" => 26, 40, 71;
                "优昙瑞", "youtanrui" => 97, 94, 168;
                "暮山紫", "mushanzi" => 164, 171, 214;
                "紫苑", "ziyuan" => 117, 124, 187;
                "延维", "yanwei" => 74, 75, 157;
                "曾青", "cengqing" => 83, 81, 100;
                "青黛", "qingdai" => 69, 70, 94;
                "䒌靘", "mingqing" => 69, 70, 89;
                "璆琳", "qiuling" => 52, 48, 65;
                "绀蝶", "gandie" => 44, 47, 59;
                "獭见", "tajian" => 21, 29, 41;
                // 碧蓝
                "天水碧", "tianshuilv" => 90, 164, 174;
                "井天", "jingtian" => 164, 201, 204;
                "云门", "yunmen" => 162, 210, 226;
                "西子", "xizi" => 135, 192, 202;
                "正青", "zhengqing" => 108, 168, 175;
                "扁青", "bianqing" => 80, 146, 150;
                "法翠", "facui" => 16, 139, 150;
                "吐绶蓝", "tushoulan" => 65, 130, 164;
                "鱼师青", "yushiqing" => 50, 120, 138;
                "软翠", "ruancui" => 0, 109, 135;
                "青緺", "qinggua" => 40, 72, 82;
                "螺子黛", "luozidai" => 19, 57, 62;
                "二绿", "erlv" => 93, 163, 157;
                "繱犗", "conghai" => 136, 191, 184;
                "铜青", "tongqing" => 61, 142, 134;
                "青雘", "qinghuo" => 0, 113, 117;
                "䌦色", "daose"=> 34, 107, 104;
                "石绿", "shilv" => 32, 104, 100;
                "竹月", "zhuyue" => 127, 159, 175;
                "月白", "yuebai" => 212, 229, 239;
                "素采", "sucai" => 212, 221, 225;
                "星郎", "xinglang" => 188, 212, 231;
                "影青", "yingqing" => 189, 203, 210;
                "逍遥游", "xiaoyaoyou" => 178, 191, 195;
                "白青", "baiqing" => 152, 182, 194;
                "青鸾", "qingluan" => 154, 167, 177;
                "东方既白", "dongfangjibai" => 139, 163, 199;
                "秋蓝", "qiulan" => 125, 146, 159;
                "空青", "kongqing" => 102, 136, 158;
                "太师青", "taishiqing" => 84, 118, 137;
                "菘蓝", "songlan" => 107, 121, 142;
                "育阳染", "yuyangran" => 87, 100, 112;
                "青雀头黛", "qingquetoudai" => 53, 78, 107;
                "霁蓝", "jilan" => 60, 70, 84;
                "瑾瑜", "jinyu" => 30, 39, 50;
                "缟羽", "gaoyu" => 239, 239, 239;
                "山矾", "shanfan" => 245, 243, 242;
                "浅云", "qianyun" => 234, 238, 241;
                "凝脂", "ningzhi" => 245, 242, 233;
                "皦玉", "jiaoyu" => 235, 238, 232;
                "玉頩", "yuping" => 234, 229, 227;
                "二目鱼", "ermuyu" => 223, 224, 217;
                "韶粉", "shaoren" => 224, 224, 208;
                "香皮", "xiangpi" => 216, 209, 197;
                "明月珰", "mingyuedang" => 212, 211, 202;
                "藕丝秋半", "ousiqiuban" => 211, 203, 197;
                "云母", "yunmu" => 198, 190, 177;
                "米汤娇", "mitangjiao" => 238, 234,217;
                "酂白", "zanbai" => 246, 249, 228;
                "吉量", "jiliang" => 235, 237, 223;
                "天球", "tianqiu" => 224, 223, 198;
                "霜地", "shuangdi" => 199, 198, 182;
                "余白", "yubai" => 201, 207, 193;
                "溶溶月", "rongrongyue" => 190, 194, 188;
                "月魄", "yuepo" => 178, 182, 182;
                "冻缥", "dongpiao" => 190, 194, 179;
                "草白", "caobai" => 191, 193, 169;
                "不皂", "buzao" => 167, 170, 161;
                "绍衣", "shaoyi" => 168, 161, 156;
                "雷雨垂", "leiyuchui" => 122, 123, 120;
                "石涅", "shinie" => 104, 106, 103;
                "墨黪", "mocan" => 88, 82, 72;
                "骋骊", "chengli" => 70, 67, 59;
                "京元", "jingyuan" => 49, 50, 44
            ],
        }
    }
}
